...
(6, '3', 2, 'test', 'test', 't', 'test@gmail.com', '$2y$10$a8fO6KtXgY4V/JwbECMhv.fxlBWDsz0yaP1ssEVOinOWUd853spSu', 'default.jpg', '2025-05-06 20:15:02');
...
(10, 'E0010', 3, 'Golfo', 'Yzabella', 'C', 'sammujumuad@gmail.com', '$2y$10$phEtarAew3wAdgOwbOhXsOmLNp3/0dJ.qAGQm3ExmsaScMFglecRW', '0005056696', '364147777_2556534734502108_424220739274862162_n.jpg', '2025-05-06 06:14:11'),
(12, '4545', 3, 'dfdfd', 'dfdf', 'd', 'testing@gmail.com', '$2y$10$GShwUGKLpzVX2vClBPvEJ.oXKEdpMjM9TMclYdkfIKT.Yy0RNon02', '0004796559', '410587651_408008551551370_2003064156466002817_n.jpg', '2025-05-06 23:36:11');
...
INSERT INTO `schedule_tbl` (`schedule_id`, `prof_user_id`, `subject_id`, `section_id`, `room_id`, `schedule_time`, `schedule_end_time`, `schedule_day`) VALUES
...
(7, 'ADS', 'Advanced Database Systems', 10);
...
--
ALTER TABLE `prof_tbl`
  MODIFY `prof_user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `student_tbl`
  MODIFY `student_user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
