...
(505, NULL, 9, 5, 16, '0005056696', '2025-05-06 16:07:44', 'check_out', '2025-05-06 16:07:51', 'Ended', '2025-05-06 16:07:44');
...
(4, 'EF001', 2, 'Jumuad', 'Sam', 'D', 'sa@ex.com', '$2y$10$1HDbMEMvhMMVPo1XnYu1Qus9dSIMnjvk8GrmCBkmvpktzKt5KQDBq', 'da2234q', NULL, '2025-05-06 16:16:28');
...
(16, 9, 5, 1, 1, '00:07:00', 'Wednesday'),
(17, 8, 5, 4, 2, '00:20:00', 'Thursday');
...
--
ALTER TABLE `attendance_tbl`
  MODIFY `attendance_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=506;

--
-- AUTO_INCREMENT for table `faculty_tbl`
--
ALTER TABLE `faculty_tbl`
  MODIFY `faculty_user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
