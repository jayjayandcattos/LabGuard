<link href="https://fonts.googleapis.com/css2?family=Bruno+Ace&display=swap" rel="stylesheet">
  ...
  <link href="https://fonts.googleapis.com/css2?family=Monomaniac+One&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="../css/prof.css">
        ...
        <nav class="text-white p-3 vh-100" style="position: fixed; left: 0; top: 110px; width: 250px; height: 100vh; overflow-y: auto;">
    ...
    <ul class="nav flex-column" style="width:100%;">
        ...
        <li class="nav-item"><a href="logout.php" class="nav-link text-white" style="margin-top:  150px; overflow-y: auto;">Logout</a></li>
    </ul>
</nav> 