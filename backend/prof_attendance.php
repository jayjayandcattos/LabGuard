...
<body>
    ...
    <div id="main-container">
        ...
        <?php if ($selected_section):
            ...
            <h2 class="my-3">
                Section:
                <?= htmlspecialchars($sections[array_search($selected_section, array_column($sections, 'section_id'))]['section_name']) ?>
            </h2>
                    ...
                    <tbody id="tablebody-attendance">
                        <?php foreach ($attendance_records as $record): ?>
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge <?= $record['attendance_status'] == 'Present' ? 'bg-success' : 'bg-danger' ?>">
